...
router.post("/course/:courseId", authMiddleware_1.authMiddleware, commentController.createCourseComment);
// Article specific comments
router.get("/article/:articleId", commentController.getArticleComments);
router.post("/article/:articleId", authMiddleware_1.authMiddleware, commentController.createArticleComment);
